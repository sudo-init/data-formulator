/**
 * TableSelectionView - Table selection and upload dialogs
 * Migrated from original TableSelectionView.tsx to Next.js with TypeScript
 */
...
import { CustomReactTable } from '../data-table/ReactTable'
import { DictTable } from "@/lib/types/componentTypes"

import DeleteIcon from '@mui/icons-material/Delete'
import { getUrls } from '@/lib/utils/chartUtils'
import { createTableFromFromObjectArray, createTableFromText, loadTextDataWrapper, loadBinaryDataWrapper } from '@/lib/data/utils'
...
import { DataFormulatorState, dfActions, dfSelectors, fetchFieldSemanticType } from '@/lib/store/slices/dataFormulatorSlice'
...
export const TableUploadDialog: React.FC<TableUploadDialogProps> = ({ buttonElement, disabled }) => {
    ...
    let handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>): Promise<void> => {
