/**
 * EncodingShelfCard - Encoding shelf with chart type selector and encoding channels
 * Migrated from original EncodingShelfCard.tsx to Next.js with TypeScript
 */
...
import { Channel, EncodingItem, ConceptTransformation, Chart, FieldItem, Trigger, duplicateChart, EncodingMap } from "@/lib/types/componentTypes"

import _ from 'lodash'

import { createDictTable, DictTable } from "@/lib/types/componentTypes"

import { getUrls, resolveChartFields } from '@/lib/utils/chartUtils'
import { EncodingBox } from './EncodingBox'

import { ChannelGroups, CHART_TEMPLATES, getChartTemplate } from '@/lib/constants/ChartTemplates'
...
export const EncodingShelfCard: FC<EncodingShelfCardProps> = function ({ chartId }) {
    ...
    let encodingBoxGroups = Object.entries(ChannelGroups)
        ...
        .map(([group, channelList]) => {
            ...
            let component = <Box key={`encoding-group-${group}`}>
